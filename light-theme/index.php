            ...
            <section class="slider-area">
                <div class="slider-active">
                    <div class="single-slider slider-bg slider-style-two">
                        ...
                        <div class="slider-img" data-animation="slideInRightS" data-delay=".6s"><img src="/local/templates/.default/img/slider/slider_img01.png" alt=""></div>
                        <div class="slider-img slider-img2" data-animation="slideInLeftS" data-delay=".6s"><img src="/local/templates/.default/img/slider/slider_img02.png" alt=""></div>
                        <div class="slider-circle-shape"><img src="/local/templates/.default/img/slider/slider_circle.png" alt="" class="rotateme"></div>
                    </div>
                    <div class="single-slider slider-bg slider-style-two" style="background-image: url(/local/templates/.default/img/slider/slider_bg.jpg);">
                        <div class="container-fluid container-full-padding">
                            <div class="row">
                                <div class="col-xl-6 col-lg-7 col-md-11">
                                    <div class="slider-content">
                            ...
                            <div class="released-game-active">
                                <div class="released-game-carousel">
                                    <div class="released-game-item">
                                        ...
                                        <div class="released-game-img">
                                            <img src="/local/templates/.default/img/images/released_game_img01.jpg" alt="">
                                        </div>
                                ...
                                <div class="released-game-carousel">
                                    <div class="released-game-item">
                                        <div class="released-game-item-bg"></div>
                                        <div class="released-game-img">
                                            <img src="/local/templates/.default/img/images/released_game_img02.jpg" alt="">
                                        </div>
                                        <div class="released-game-content">
                                            <div class="released-game-rating">
                                                <h5>Rating :</h5>
                                ...
                                <div class="released-game-carousel">
                                    <div class="released-game-item">
                                        <div class="released-game-item-bg"></div>
                                        <div class="released-game-img">
                                            <img src="/local/templates/.default/img/images/released_game_img03.jpg" alt="">
                                        </div>
                                        <div class="released-game-content">
                                            <div class="released-game-rating">
                                                <h5>Rating :</h5>
                        ...
                        <div class="col-xl-4 col-lg-12">
                            <div class="released-game-nav">
                                <div class="released-game-nav-item">
                                    <img src="/local/templates/.default/img/images/release_game_nav01.jpg" alt="">
                                </div>
                                <div class="released-game-nav-item">
                                    <img src="/local/templates/.default/img/images/release_game_nav02.jpg" alt="">
                                </div>
                                <div class="released-game-nav-item">
                                    <img src="/local/templates/.default/img/images/release_game_nav03.jpg" alt="">
                                </div>
                                <div class="released-game-nav-item">
                                    <img src="/local/templates/.default/img/images/release_game_nav02.jpg" alt="">
                                </div>
                    ...
                    <div class="row">
                                ...
                                <ul>
                                    <li>
                                        <div class="just-gamers-list-icon">
                                            <img src="/local/templates/.default/img/icon/gamer_list_icon01.png" alt="">
                                        </div>
                                    ...
                                    <li>
                                        <div class="just-gamers-list-icon">
                                            <img src="/local/templates/.default/img/icon/gamer_list_icon02.png" alt="">
                                        </div>
                                        <div class="just-gamers-list-content fix">
                                    ...
                                    <li>
                                        <div class="just-gamers-list-icon">
                                            <img src="/local/templates/.default/img/icon/gamer_list_icon03.png" alt="">
                                        </div>
                                        <div class="just-gamers-list-content fix">
                        ...
                        <div class="col-xl-7 col-lg-6 d-none d-lg-block">
                            <div class="just-gamers-img">
                                <img src="/local/templates/.default/img/images/just_gamers_img.png" alt="" class="just-gamers-character">
                                <div class="just-gamers-circle-shape">
                                    <img src="/local/templates/.default/img/images/gamers_circle_line.png" alt="">
                                    <img src="/local/templates/.default/img/images/gamers_circle_shape.png" alt="" class="rotateme">
                                </div>
                                <img src="/local/templates/.default/img/images/just_gamers_chart.png" alt="" class="gamers-chart-shape">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    ...
                    <div class="row featured-active">
                        <div class="col-lg-4 col-sm-6 grid-item">
                            <div class="featured-game-item mb-30">
                                <div class="featured-game-thumb">
                                    <img src="/local/templates/.default/img/images/featured_game_thumb01.jpg" alt="">
                                </div>
                                ...
                                <div class="featured-game-content featured-game-overlay-content">
                                    <div class="featured-game-icon"><img src="/local/templates/.default/img/icon/featured_game_icon.png" alt=""></div>
                                    <h4><a href="#">JUST FOR <span>GAMERS</span></a></h4>
                                    <div class="featured-game-meta">
                                        <i class="fas fa-bell"></i>
                                        <span>Playstation 5 , Xbox</span>
                        ...
                        <div class="col-lg-4 col-sm-6 grid-item">
                            <div class="featured-game-item mb-30">
                                <div class="featured-game-thumb">
                                    <img src="/local/templates/.default/img/images/featured_game_thumb02.jpg" alt="">
                                </div>
                                <div class="featured-game-content">
                                    <h4><a href="#">JUST FOR <span>GAMERS</span></a></h4>
                                    <div class="featured-game-meta">
                        ...
                        <div class="col-lg-4 col-sm-6 grid-item">
                            <div class="featured-game-item mb-30">
                                <div class="featured-game-thumb">
                                    <img src="/local/templates/.default/img/images/featured_game_thumb03.jpg" alt="">
                                </div>
                                <div class="featured-game-content">
                                    <h4><a href="#">JUST FOR <span>GAMERS</span></a></h4>
                                    <div class="featured-game-meta">
                        ...
                        <div class="col-lg-4 col-sm-6 grid-item">
                            <div class="featured-game-item mb-30">
                                <div class="featured-game-thumb">
                                    <img src="/local/templates/.default/img/images/featured_game_thumb04.jpg" alt="">
                                </div>
                                <div class="featured-game-content">
                                    <h4><a href="#">JUST FOR <span>GAMERS</span></a></h4>
                                    <div class="featured-game-meta">
                        ...
                        <div class="col-lg-4 col-sm-6 grid-item">
                            <div class="featured-game-item mb-30">
                                <div class="featured-game-thumb">
                                    <img src="/local/templates/.default/img/images/featured_game_thumb06.jpg" alt="">
                                </div>
                                <div class="featured-game-content">
                                    <h4><a href="#">JUST FOR <span>GAMERS</span></a></h4>
                                    <div class="featured-game-meta">
                        ...
                        <div class="col-lg-4 col-sm-6 grid-item">
                            <div class="featured-game-item mb-30">
                                <div class="featured-game-thumb">
                                    <img src="/local/templates/.default/img/images/featured_game_thumb05.jpg" alt="">
                                </div>
                                <div class="featured-game-content">
                                    <h4><a href="#">JUST FOR <span>GAMERS</span></a></h4>
                                    <div class="featured-game-meta">
                ...
                <div class="container">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-xl-5 col-lg-6">
                            <div class="cta-img">
                                <img src="/local/templates/.default/img/images/cta_img.png" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="cta-content">
                                <div class="cta-icon mb-15">
                                    <img src="/local/templates/.default/img/icon/cta_icon.png" alt="">
                                </div>
                ...
                <div class="container">
                    ...
                    <div class="row product-active">
                        <div class="col-xl-3">
                            <div class="shop-item">
                                <div class="product-thumb">
                                    <a href="#"><img src="/local/templates/.default/img/product/s_product_img01.jpg" alt=""></a>
                                </div>
                        ...
                        <div class="col-xl-3">
                            <div class="shop-item">
                                <div class="product-thumb">
                                    <a href="#"><img src="/local/templates/.default/img/product/s_product_img02.jpg" alt=""></a>
                                </div>
                                <div class="product-content">
                        ...
                        <div class="col-xl-3">
                            <div class="shop-item">
                                <div class="product-thumb">
                                    <a href="#"><img src="/local/templates/.default/img/product/s_product_img03.jpg" alt=""></a>
                                </div>
                                <div class="product-content">
                        ...
                        <div class="col-xl-3">
                            <div class="shop-item">
                                <div class="product-thumb">
                                    <a href="#"><img src="/local/templates/.default/img/product/s_product_img04.jpg" alt=""></a>
                                </div>
                                <div class="product-content">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="blog-post blog-style-two mb-50">
                                <div class="blog-thumb mb-30">
                                    <a href="#"><img src="/local/templates/.default/img/blog/s_blog_thumb01.jpg" alt=""></a>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="blog-post blog-style-two mb-50">
                                <div class="blog-thumb mb-30">
                                    <a href="#"><img src="/local/templates/.default/img/blog/s_blog_thumb02.jpg" alt=""></a>
                                </div>
                                <div class="blog-post-content">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="blog-post blog-style-two mb-50">
                                <div class="blog-thumb mb-30">
                                    <a href="#"><img src="/local/templates/.default/img/blog/s_blog_thumb03.jpg" alt=""></a>
                                </div>
                                <div class="blog-post-content">
