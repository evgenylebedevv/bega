    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 order-0 order-lg-2">
                <div class="about-img">
                    <img src="/local/templates/.default/img/images/about_us_img.jpg" alt="">
                    <a href="https://www.youtube.com/watch?v=_LTiEXMc5J0" class="popup-video"><img src="/local/templates/.default/img/icon/play_btn.png" alt=""></a>
                </div>
            </div>
            <div class="col-lg-6">
