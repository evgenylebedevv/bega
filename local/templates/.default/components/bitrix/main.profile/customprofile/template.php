...
<p><input class="btn" type="submit" name="code_submit_button" value="<?echo GetMessage("main_profile_send")?>" /></p>
...
<div class="profile-link profile-user-div-link"><a title="<?=GetMessage("REG_SHOW_HIDE")?>" href="javascript:void(0)" onclick="SectionClick('reg')"><h2><?=GetMessage("REG_SHOW_HIDE")?></h2></a></div>
...
<table class="data-table profile-table">
	...
	<p><input class="btn" type="submit" name="save" value="<?=(($arResult["ID"]>0) ? GetMessage("MAIN_SAVE") : GetMessage("MAIN_ADD"))?>">&nbsp;&nbsp;<input class="btn" type="reset" value="<?=GetMessage('MAIN_RESET');?>"></p>
</form>
<?//
