    ...
    <? if ($arResult["FORM_TYPE"] == "login"): ?>
        ...
        <form name="system_auth_form<?= $arResult["RND"] ?>" method="post" target="_top"
            ...
            <table width="95%">
                ...
                <?endif ?>
                <tr>
                    <td colspan="2"><input class="btn" type="submit" name="Login" value="<?= GetMessage("AUTH_LOGIN_BUTTON") ?>"/>
                    </td>
                </tr>
            ...
            <table width="95%">
                ...
                <tr>
                    <td align="center">
                        ...
                        <input class="btn" type="submit" name="logout_butt" value="<?= GetMessage("AUTH_LOGOUT_BUTTON") ?>"/>
                    </td>
                </tr>
            </table>
        </form>
