...
<table>
	<thead>
		<tr>
			<td style="align-items: center; text-align: center; " colspan="2"><b><h2><?=GetMessage("AUTH_REGISTER")?></h2></b></td>
		</tr>
	</thead>
	<tbody>
...
if ($arResult["USE_CAPTCHA"] == "Y")
{
	?>
        <br>
		<tr>
			<td colspan="2"><b><br><?=GetMessage("REGISTER_CAPTCHA_TITLE")?></b></td>
		</tr>
		<tr>
			<td></td>
			<td>
...
?>
	...
	<tfoot>
		<tr>
			<td></td>
			<td><br><input class="btn" type="submit" name="register_submit_button" value="<?=GetMessage("AUTH_REGISTER")?>" /></td>
		</tr>
	</tfoot>
</table>
</form>
