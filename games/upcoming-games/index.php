                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="upcoming-game-item mb-40">
                                ...
                                <p>Compete with players remote island winner takes showdown known issue.</p>
                                <div class="upcoming-game-thumb">
                                    <img src="/local/templates/.default/img/images/upcoming_game_thumb04.jpg" alt="">
                                    <div class="upcoming-game-cart">
                                        <a href="#" class="btn transparent-btn"><i class="fas fa-shopping-basket"></i>BUY Now</a>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="upcoming-game-item mb-40">
                                ...
                                <p>Compete with players remote island winner takes showdown known issue.</p>
                                <div class="upcoming-game-thumb">
                                    <img src="/local/templates/.default/img/images/upcoming_game_thumb05.jpg" alt="">
                                    <div class="upcoming-game-cart">
                                        <a href="#" class="btn transparent-btn"><i class="fas fa-shopping-basket"></i>BUY Now</a>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="upcoming-game-item mb-40">
                                ...
                                <p>Compete with players remote island winner takes showdown known issue.</p>
                                <div class="upcoming-game-thumb">
                                    <img src="/local/templates/.default/img/images/upcoming_game_thumb06.jpg" alt="">
                                    <div class="upcoming-game-cart">
                                        <a href="#" class="btn transparent-btn"><i class="fas fa-shopping-basket"></i>BUY Now</a>
                                    </div>
                                </div>
